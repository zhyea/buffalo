...
<div class="container main">
	...
	<table id="featureTable"
		...
		<tr>
			...
			<th data-align="center" data-formatter="recordsFormatter">记录</th>
...
<script>
    ...
    function recordsFormatter(value, row, index) {
        return '<a href="<?= $ctx_site ?>/admin/feature/record_page/' + row.id + '" target="_self"><span class="badge">查看</span></a>';

    }

    function operateFormatter(value, row, index) {
        if (1 < row.id * 1) {
            return '<a href="<?= $ctx_site ?>/admin/feature/delete/' + row.id + '" target="_self">删除</a>';
        }
    }
