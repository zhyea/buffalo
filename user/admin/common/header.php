	...
	<div class="container navigator">
		<nav class="navbar navbar-inverse">
			...
			<ul class="nav navbar-nav navbar-left" id="main-nav-items">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu navbar-child">
						...
						<li class="navbar-child-item"><a href="<?= $ctx_site ?>/admin/author/list_page">作者管理</a></li>
				...
				<li class="dropdown">
					<a href="#"
					   ...
					   aria-expanded="false"><span class="glyphicon glyphicon-pencil"></span> 撰写<span
								class="caret"></span></a>
					<ul class="dropdown-menu navbar-child">
						<li class="navbar-child-item"><a href="<?= $ctx_site ?>/admin/work/remote_code">远程写</a></li>
					</ul>
				</li>
			</ul>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="<?= $ctx_site ?>/admin/admin/logout"><span class="glyphicon glyphicon-off"></span> 登出</a>
				</li>
			</ul>
		</nav>
	</div>
